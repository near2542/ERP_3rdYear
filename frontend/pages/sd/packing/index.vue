                    ...
                    <b-thead head-variant="dark">
                     ...
                     <b-tbody>
                        <b-tr v-for="(data,index) in filtered" :key="data.idDoc">
                            ...
                            <nuxt-link :to="`/sd/billing/create?ref=${data.idDoc}`">Bill the customer</nuxt-link>
                            <nuxt-link :to="`/sd/packing/${data.idDoc}`"><b-icon-eye-fill class="mr-2" variant="success"  scale="1.5"></b-icon-eye-fill></nuxt-link>
