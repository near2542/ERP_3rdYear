<template>
    <div class="middle">
       ...
       <nuxt-link to="/mm/requistion/create"> <b-button variant="success">Create Purchase Requistion</b-button> </nuxt-link>
       <div class="search" >
       <b-form-input
            class="col-4"
          id="input-1"
        ...
        <b-table-simple hover caption-top bordered striped>
                    ...
                    <b-thead head-variant="dark">
                     ...
                     <b-tbody>
                        <b-tr v-for="(requistion,index) in filtered" :key="requistion.idDoc">
                              <b-td colspan="3">{{requistion.idDoc}}</b-td>
                              ...
                              <b-td colspan="3">{{requistion.ValidTo}}</b-td>
                              <b-td colspan="4">
                                
                              <div v-if="requistion.Stat == 1">
                            <nuxt-link :to="`/mm/purchase/create?ref=${requistion.idDoc}`">Make Purchase Order</nuxt-link>
...
<script>
  ...
  {
    const data = await $axios.$get('/api/mm/requistion')
