                    ...
                    <b-thead head-variant="dark">
                     ...
                     <b-tbody>
                        <b-tr v-for="(requistion) in filtered" :key="requistion.idDoc">
                              ...
                              <b-td colspan="2">#GR{{requistion.idRef}}</b-td>
                            ...
                            <nuxt-link :to="`/mm/invoices/${requistion.idDoc}`"><b-icon-eye-fill class="mr-2" variant="success"  scale="1.5"></b-icon-eye-fill></nuxt-link>
...
<script>
  ...
  {
    const data = await $axios.$get('/api/mm/invoices')
